...
{
    public class RepaintedAssetField<T> : Button where T : Object
    {
        ...
        public FlexibleAssetField<T> Background;
        public Image Icon;
        public Label Name;
        ...
        public RepaintedAssetField(T objectBinded = null) : base()
        {
            ...
            Background = new FlexibleAssetField<T>().AddClass(_uss_background);
