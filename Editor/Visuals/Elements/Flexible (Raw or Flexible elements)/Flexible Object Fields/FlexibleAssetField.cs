...
{
    public class FlexibleAssetField<T> : Button where T : UnityEngine.Object
    {
        ...
        public FlexibleAssetField() : base()
        {
        ...
        {
            var element = evt.currentTarget as FlexibleAssetField<T>;
            action?.Invoke();
