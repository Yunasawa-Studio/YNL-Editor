...
{
    public class FlexibleAssetsField<T> : Button where T : UnityEngine.Object
    {
        ...
        public FlexibleAssetsField() : base()
        {
        ...
        {
            var element = evt.currentTarget as FlexibleAssetsField<T>;
            action?.Invoke();
