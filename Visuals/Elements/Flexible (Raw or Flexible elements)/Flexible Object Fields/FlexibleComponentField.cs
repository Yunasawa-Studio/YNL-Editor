...
{
    public class FlexibleComponentField<T> : Button where T : UnityEngine.Object
    {
        ...
        public FlexibleComponentField() : base()
        {
        ...
        {
            var element = evt.currentTarget as FlexibleComponentField<T>;
            action?.Invoke();
